...
export const EXERCISE_CATEGORIES = {
  ...
  shoulders: { name: 'Ombros', icon: '🏋️', color: 'bg-yellow-500/10 text-yellow-600' },
  arms: { name: 'Braços', icon: '💪', color: 'bg-purple-500/10 text-purple-600' },
