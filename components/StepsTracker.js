    ...
    <div className="space-y-6">
      ...
      <Card className="glass-card border-phoenix-amber/20">
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            <Footprints className="w-6 h-6 text-phoenix-amber" />
            Passos de Hoje
          </CardTitle>
          <CardDescription>
            Meta diária: {STEPS_GOAL.toLocaleString()} passos
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          {loading && (
            <div className="text-center py-8 text-muted-foreground">
              ...
              >
                <Footprints className="w-8 h-8 text-phoenix-amber" />
              </motion.div>
              ...
              <div className="absolute inset-0 flex items-center justify-center flex-col">
                ...
                {isGoalReached && (
                  <motion.div
                    ...
                    className="absolute -bottom-2 bg-gradient-to-r from-phoenix-amber to-phoenix-gold text-white text-[10px] font-bold px-3 py-1 rounded-full shadow-lg"
                  >
                    META ATINGIDA! 🎯
                  </motion.div>
                )}
              ...
              <div className="grid grid-cols-2 gap-3">
                <motion.div 
                  ...
                  animate={isGoalReached ? {
                    backgroundColor: ['rgba(255, 179, 0, 0.1)', 'rgba(255, 179, 0, 0.2)', 'rgba(255, 179, 0, 0.1)']
                  } : {}}
                  transition={{
                    duration: 2,
                    repeat: isGoalReached ? Infinity : 0,
          ...
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.2 }}
            className={`p-4 rounded-lg border-2 ${motivation.bgColor} ${motivation.borderColor} ${isGoalReached ? 'relative overflow-hidden' : ''}`}
          >
            ...
            {isGoalReached && (
              <>
                ...
                {[...Array(8)].map((_, i) => (
                  <motion.div
                    key={i}
                    className="absolute w-1 h-1 bg-phoenix-amber rounded-full"
                    initial={{ 
                      x: '50%',
                      y: '50%',
                      scale: 0,
            ...
            <div className="flex items-start gap-3 relative z-10">
              ...
              <div className="flex-1">
                <motion.h3 
                  className={`font-bold text-lg ${motivation.color} mb-1`}
                  animate={isGoalReached ? {
                    scale: [1, 1.05, 1]
                  } : {}}
                  transition={{
        ...
        <Card className="glass-card">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-base">
              <Calendar className="w-5 h-5 text-phoenix-amber" />
              Últimos 7 Dias
            </CardTitle>
            <CardDescription>
              Progresso semanal de passos
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="h-64">
      ...
      <Card className="glass-card border-blue-500/20">
        <CardHeader>
          ...
          <CardDescription>
            Sincronize automaticamente seus passos do iPhone
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="flex items-start gap-3 p-4 rounded-lg bg-blue-500/10 border border-blue-500/20">
            ...
            <div className="flex-1 text-sm">
              ...
              <p className="text-muted-foreground">
                Configure um atalho do iOS para enviar seus passos diários automaticamente do Apple Health.
              </p>
            </div>
          </div>
          ...
          {showInstructions && (
            <motion.div
              ...
              className="space-y-4 p-4 rounded-lg bg-secondary/30 border border-dashed"
            >
              ...
              <div className="space-y-3 text-sm">
                <div className="flex gap-3">
                  <div className="flex-shrink-0 w-6 h-6 rounded-full bg-phoenix-amber text-white flex items-center justify-center text-xs font-bold">
                    1
                  </div>
                  <div>
                    <p className="font-medium">Abra o app Atalhos</p>
                    <p className="text-muted-foreground">No seu iPhone, abra o app "Atalhos" (Shortcuts)</p>
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Toque no botão "+" e adicione as seguintes ações:</p>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground mb-2">Na ação "Obter Conteúdos de URL":</p>
                    <ul className="list-disc list-inside ml-4 space-y-1 text-muted-foreground">
                      <li>URL: Use a URL abaixo</li>
                      <li>Método: POST</li>
                      <li>Corpo: JSON</li>
                    </ul>
                    <code className="block p-2 rounded bg-black/20 dark:bg-white/10 text-xs break-all mt-2">
                      {typeof window !== 'undefined' ? window.location.origin : 'https://seu-dominio.com'}/api/steps
                    </code>
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground mb-2">Configure o corpo da requisição:</p>
                    <code className="block p-2 rounded bg-black/20 dark:bg-white/10 text-xs">
                      {`{
  "steps": [Contagem],
  "date": "[Data Atual]" (formato YYYY-MM-DD)
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Na aba "Automação", crie uma nova automação para executar este atalho automaticamente às 23h todos os dias.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-3 rounded-lg bg-green-500/10 border border-green-500/20">
                <p className="text-xs text-green-600 dark:text-green-400">
                  ✅ <strong>Pronto!</strong> A API /api/steps está configurada para receber os dados do seu iPhone automaticamente.
                </p>
              </div>
            </motion.div>
          )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div className="flex items-start gap-3 p-3 rounded-lg bg-secondary/30">
              ...
              <div className="text-sm">
                <p className="font-medium mb-1">Saúde Cardiovascular</p>
            ...
            <div className="flex items-start gap-3 p-3 rounded-lg bg-secondary/30">
              ...
              <div className="text-sm">
                <p className="font-medium mb-1">Saúde Mental</p>
            ...
            <div className="flex items-start gap-3 p-3 rounded-lg bg-secondary/30">
              <div className="text-2xl">⚡</div>
              <div className="text-sm">
                <p className="font-medium mb-1">Mais Energia</p>
            ...
            <div className="flex items-start gap-3 p-3 rounded-lg bg-secondary/30">
              <div className="text-2xl">💪</div>
              <div className="text-sm">
                <p className="font-medium mb-1">Controle de Peso</p>
