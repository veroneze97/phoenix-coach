...
// - `React.ElementRef<typeof TooltipPrimitive.Content>`: Tipa a `ref`.
// - `React.ComponentPropsWithoutRef<typeof TooltipPrimitive.Content>`: Herda todas as props do primitivo.
//   Isso inclui props como `side`, `align`, `sideOffset`, `collisionPadding`, etc.
