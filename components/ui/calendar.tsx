...
// --- Tipagem para o componente Calendar ---

interface CalendarProps extends DayPickerProps {
  className?: string
  classNames?: Partial<Components>
...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      components={{
        Root: ({ className, rootRef, ...props }: Components['Root']) => {
          return <div data-slot="calendar" ref={rootRef} className={cn(className)} {...props} />
        },
        Chevron: ({ className, orientation, ...props }: Components['Chevron']) => {
          if (orientation === 'left') {
        ...
        WeekNumber: ({ children, ...props }: Components['WeekNumber']) => {
          return (
            <td {...props}>
...
// --- Tipagem para o componente CalendarDayButton ---
