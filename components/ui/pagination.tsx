...
// Adicionei `forwardRef` ao componente principal para melhor composição e acessibilidade.
...
// A tipagem do PaginationLink é a mais complexa. Ela combina:
// 1. Props de um elemento <a> (React.AnchorHTMLAttributes)
// 2. As variantes do botão (VariantProps<typeof buttonVariants>)
// 3. A prop customizada `isActive`
...
// Adicionei `forwardRef` ao link, o que é uma boa prática para componentes de navegação.
...
// Componentes que herdam as props do PaginationLink
