...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      // Empilha no topo no mobile; no desktop, base inferior direita
...
/**
 * Props públicas do Toast Root (não incluem título/descrição — esses são
 * componentes independentes). Exportado para uso em outros módulos.
 */
  ...
  <ToastPrimitives.Action
    ...
    className={cn(
      [
        ...
        // Variante destrutiva via parent `.group`
